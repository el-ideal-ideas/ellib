// Based on https://github.com/shomali11/util/blob/master/xhashes/xhashes.go
// Usa elstr.UnsafeToBytes to improve performance.
...
func stringHasher(algorithm hash.Hash, text string) string {
	_, _ = algorithm.Write(elstr.UnsafeToBytes(text))
